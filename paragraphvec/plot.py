...
def plot_category(ingr2vec, ingr2vec_tsne, path, ingr2cate=None, withLegends=False):
	...
	if withLegends:
		...
		category2color = {
			'Additive' :  sns.xkcd_rgb["golden yellow"],
			'Animal Product' : sns.xkcd_rgb["light pink"],
			'Bakery' : sns.xkcd_rgb["brown"],
			'Beverage' : sns.xkcd_rgb["magenta"],
			'Beverage Alcoholic' : sns.xkcd_rgb["purple"],
			'Cereal' : sns.xkcd_rgb["light brown"],
			'Dairy' : sns.xkcd_rgb["yellow"],
			'Dish' : sns.xkcd_rgb["blue"],
			'Essential Oil' : sns.xkcd_rgb["puke yellow"],
			'Flower' : sns.xkcd_rgb["pink"],
			'Fruit' : sns.xkcd_rgb["olive"],
			'Fungus' : sns.xkcd_rgb["navy"],
			'Meat' : sns.xkcd_rgb["red"],
			'Nut/Seed' : sns.xkcd_rgb["greenish brown"],
			'Plant' : sns.xkcd_rgb["green"],
			'Seafood' : sns.xkcd_rgb["ocean"],
			'Spice' : sns.xkcd_rgb["maroon"],
			'Vegetable' : sns.xkcd_rgb["dark green"],
			'None' : sns.xkcd_rgb["black"],
		}

		category_order = ['Additive', 'Animal Product', 'Bakery', 'Beverage', 'Beverage Alcoholic', 'Cereal',
		'Dairy', 'Dish', 'Essential Oil', 'Flower', 'Fruit', 'Fungus', 'Meat', 'Nut/Seed', 'Plant', 'Seafood', 'Spice', 'Vegetable', 'None']
